...
> **Экспериментально:** навыки для агентов — ранняя возможность. Сценарии и инструкции пока не проходили полное тестирование на разных сайтах и в разных средах агентов; используйте с осторожностью на рабочих зеркалах.
